		...
		<tr>
			<td>
				...
				<table style="display: inline-table; margin:0 auto" border="0" cellpadding="0" cellspacing="0" width="500">
					<p>Hola, <?php echo $nombre ?> te ha enviado el siguiente mensaje a través de <?php echo CHtml::link('El directorio de artistas de la feria de las flores', CHtml::normalizeUrl('http://www.feriadelasfloresmedellin.gov.c/directorio') ); ?>: </p>
