            ...
            'items'=>array(
              array( 'label' => 'Música' , 'url' => array('/musica'), 'active' => strpos($ru, 'musica'),
                'items' => array(
                  ...
                  array('label' => 'Popular urbana'     , 'url' => array('/directorio/musica/urbana')                        , 'active' => strpos($ru, 'urbana')),
                  array('label' => 'Clásica'            , 'url' => array('/directorio/musica/clasica')                       , 'active' => strpos($ru, 'clasica')),
                  array('label' => 'Folclor'            , 'url' => array('/directorio/musica/folclor')                       , 'active' => strpos($ru, 'folclor')),
                  array('label' => 'Jazz y músicas del mundo', 'url' => array('/directorio/musica/jazz-y-musicas-del-mundo') , 'active' => strpos($ru, 'jazz-y-musicas-del-mundo')),
                  array('label' => 'Fusión'             , 'url' => array('/directorio/musica/fusion')                        , 'active' => strpos($ru, 'fusion')),
                  array('label' => 'Experimental'       , 'url' => array('/directorio/musica/experimental')                  , 'active' => strpos($ru, 'experimental')),
                  array('label' => 'Infantil'           , 'url' => array('/directorio/musica/infantil')                      , 'active' => strpos($ru, 'infantil')),
                ),
              ),
              array( 'label' => 'Danza'  , 'url' => array('/directorio/danza')             , 'active' => strpos($ru, 'danza') ),
              array( 'label' => 'Teatro' , 'url' => array('/directorio/teatro')            , 'active' => strpos($ru, 'teatro') ),
              array( 'label' => 'Otras artes'  , 'url' => array('/directorio/otras-artes') , 'active' => strpos($ru, 'otras-artes'),
                'items' => array(
                  array('label' => 'Magia'      , 'url' => array('/directorio/otras-artes/magia')      , 'active' => strpos($ru, 'magia')),
                  array('label' => 'Clown'      , 'url' => array('/directorio/otras-artes/clown')      , 'active' => strpos($ru, 'clown')),
                  array('label' => 'Malabarismo', 'url' => array('/directorio/otras-artes/malabarismo'), 'active' => strpos($ru, 'malabarismo')),
                  array('label' => 'Mimos'      , 'url' => array('/directorio/otras-artes/mimos')      , 'active' => strpos($ru, 'mimos')),
                  array('label' => 'Cuentería'  , 'url' => array('/directorio/otras-artes/cuenteria')  , 'active' => strpos($ru, 'cuenteria')),
                  array('label' => 'Humor'      , 'url' => array('/directorio/otras-artes/humor')      , 'active' => strpos($ru, 'humor')),
                ),
              ),
            ),
          )
